...
Все сообщения в секретных чатах передаются в зашифрованном виде. Когда вы создаёте чат, устройство генерирует ключ шифрования – специальный код, с помощью которого ваше устройство и устройство собеседника расшифровывают содержимое сообщения. Без этого кода устройство не сможет распознать сообщение или файл и отобразить его в читаемом виде.
...
Если изображение и ключ и у вас, и у собеседника одинаковы – чат защищён от злоумышленников. Ключ тоже хранится только на двух устройствах – не в облаке. Доступ к нему есть только у вас и у собеседника.
